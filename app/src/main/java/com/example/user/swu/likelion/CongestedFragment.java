...
public class CongestedFragment extends Fragment  {

    public CongestedFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        r102.setStation1("삼각지");
        r102.setStation2("동작");
        r102.setStation3("건대입구");
        r102.setTransfer1(4);
        r102.setTransfer2(7);
        r102.setTime(31);
        ...
        r202.setStation1("삼각지");
        r202.setStation2("신당");
        r202.setStation3("건대입구");
        r202.setTransfer1(6);
        r202.setTransfer2(2);
        r202.setTime(28);
        ...
        r503.setStation1("삼각지");
        r503.setStation2("청구");
        r503.setStation3("동대문역사문화공원");
        r503.setStation4("건대");
        r503.setTransfer1(6);
        r503.setTransfer2(5);
        r503.setTransfer3(2);
