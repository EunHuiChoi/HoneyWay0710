...
public class SelectActivity extends AppCompatActivity implements ModifyFragment.ModifytListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        StationAdapter stationAdapter = new StationAdapter(SelectActivity.this, stationList4);//Adapter를 생성한다.
        lstStation4.setAdapter(stationAdapter);//Adapter를 ListView에 부착시킨다.
